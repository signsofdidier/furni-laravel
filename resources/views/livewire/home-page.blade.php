<div>
    ...
    <section class="py-20">
        ...
        <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0 flex justify-center">
                        ...
                        <div class="p-4 md:p-5">
                            <div class="flex justify-between items-center">
                                <div class="flex items-center">
                                    <img class="object-cover h-[3rem] w-[3rem] rounded-full" src="{{ url('storage', $category->image) }}" alt="{{ $category->name }}">
                                    <div class="ms-3">
