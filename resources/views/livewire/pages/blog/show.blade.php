                ...
                <div class="col-lg-9 col-md-12 col-12">
                    <div class="article-rte">
                        ...
                        <div class="next-prev-article mt-5 d-flex align-items-center justify-content-between">
                            ...
                            @if($prevBlog)
                                <a href="{{ route('blog.show', $prevBlog->slug) }}" class="article-btn prev-article-btn mt-2">PREV ARTICLE</a>
                            @endif

                            @if($nextBlog)
                                    <a href="{{ route('blog.show', $nextBlog->slug) }}" class="article-btn next-article-btn active mt-2">NEXT ARTICLE</a>
                            @endif
                        </div>
