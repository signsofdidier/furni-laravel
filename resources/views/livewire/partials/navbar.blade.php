            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-md-8 col-8">
                    <div class="header-action d-flex align-items-center justify-content-end">
                        ...
                        <a wire:navigate class="header-action-item header-wishlist ms-4 d-none d-lg-block"
                           href="wishlist.html">
                        ...
                        <a wire:navigate class="header-action-item header-cart ms-4" href="#drawer-cart"
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        --}}
{{-- Login button enkel zichtbaar voor niet ingelogde users --}}{{--
                        ...
                        <!-- User Dropdown -->
                        @auth()
                            <div class="hs-dropdown relative inline-flex [--placement:bottom-right] md:py-4">
                                <button id="user-dropdown-toggle" type="button"
                                        class="flex items-center gap-x-2 text-gray-500 hover:text-gray-400 font-medium dark:text-gray-400 dark:hover:text-gray-500">
                                    {{ Auth()->user()->name }}
                                ...
                                <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 w-48 hidden z-10 mt-2 min-w-[12rem] bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700"
